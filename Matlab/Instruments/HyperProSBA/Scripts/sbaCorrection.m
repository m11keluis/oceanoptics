...
%% Customize for your system here
...
for file = 1:length(matfileFolder)
    ...
    clear hdfdata tiltraw Ls_tilt Lsraw Lsraw1 Esraw Esraw1 Esraw1_0 Es_tilt Rrs Rrs_avg Rrs_std Rrs_tilt rrsw rrs temp temp1 temp2
    end
