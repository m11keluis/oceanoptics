...
temp1=cd('/Users/kellyluis/Desktop/SBA_shadowcorr_public/'); %###get current folder###
temp2=cd('/Users/kellyluis/Desktop/Lab/Dock_Measurments/1908224_Dock   /'); %###get current folder###
...
%##### reading Rrs #################################################
filename=strcat(scriptfolder,'2019-226-171453_L2s.raw');
fidin=fopen(filename);
